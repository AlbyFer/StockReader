...
path_to_save = '/Users/albertoferrando/Google Drive/Progetti/Investimenti/BorsaReader/Storage/Obs_mat.csv'
...
for ticker in financials.keys():
    ...
    data.append(format_financials_prices(financials, ticker, path_to_folder_prices, ratios))
